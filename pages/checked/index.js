...
Page({
  ...
  getCheckedList(){
    let _this = this;
    let prams = {
      StartDate: _this.data.form.StartDate,
      EndDate: _this.data.form.EndDate,
      Name: App.nullReturnEmpty(_this.data.form.Name),
      Phone: App.nullReturnEmpty(_this.data.form.Phone),
      Type: App.globalData.tab_bar_type,
      CheckStatus:2 //0 未审核 1 审核通过 -1 审核拒绝 2 已审核
    }
    console.log('prams', prams)
    let url = "api/visitors/getListByNameOrPhone4Checked"
